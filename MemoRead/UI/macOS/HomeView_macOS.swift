...
struct HomeView_macOS: View {
    // MARK: - State
    @State private var selectedType: ReadingCardType?
    @State private var searchText: String = ""
    @State private var sortOption: ReadingCardSortOption = .timeAscending
...
private struct MemoListView: View {
    let selectedType: ReadingCardType?
    @Binding var searchText: String
    @Binding var sortOption: ReadingCardSortOption
